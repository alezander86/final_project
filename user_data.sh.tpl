...
echo "<h2>Webserver with IP: $extIP</h2><br>Build by Terrafrom!<br>${version}<br>$python_version<br>$ansible_version<br> token $TOKEN <br> token ${TELEGRAM_TOKEN} " > /var/www/html/index.html
